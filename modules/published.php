...
$(function() {
	...
	function getData() {
		$.ajax({
			type : "GET",
			url : "<?= $Path;?>/sched/order/published-list",
			dataType : "json",
			success : function(data) {
				...
				if(data.code == "0") {
					...
					$.each(data.data, function(i,o) {
						...
						var h = '<tr><td>'+o.orderNo+'</td><td>'+t+'</td><td>'+status[o.status]+'</td><td>'+o.provinceFrom+o.cityFrom+o.districtFrom+'</td><td>'+o.provinceTo+o.cityTo+o.districtTo+'</td><td>'+o.goodsCnt+'</td><td>'+o.totalWeight+'</td><td>'+o.pickupDrop+'</td></tr>';
						c.append(h)
					})
				}
			}
